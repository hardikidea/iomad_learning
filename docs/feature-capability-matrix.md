...
| White label | Company logo/favicon, palette, typography, contact/email copy and hostname branding | Configured baseline | IOMAD company branding remains authoritative; `theme_iomad_learning` supplies maintainable fallbacks and 235 allow-listed design tokens |
