...
$string['calltoactioncontinue'] = 'Review {$a} <i class="fa fa-angles-right" aria-hidden="true"></i>';
$string['calltoactionrestricted'] = '<i class="fa fa-lock"></i>';
$string['calltoactionstart'] = 'Open {$a} <i class="fa fa-angles-right" aria-hidden="true"></i>';
$string['calltoactionview'] = 'Review {$a} <i class="fa fa-angles-right" aria-hidden="true"></i>';
...
$string['completion-shorthand-alt-auto-fail'] = 'Failed <i class="fa fa-triangle-exclamation text-white" aria-hidden="true"></i>';
$string['completion-shorthand-alt-auto-n'] = 'Not completed';
$string['completion-shorthand-alt-auto-n-override'] = 'Not completed <i class="fa fa-triangle-exclamation text-white" aria-hidden="true"></i>';
$string['completion-shorthand-alt-auto-pass'] = 'Completed (achieved pass grade)';
$string['completion-shorthand-alt-auto-y'] = 'Completed';
$string['completion-shorthand-alt-auto-y-override'] = 'Completed <i class="fa fa-triangle-exclamation text-white" aria-hidden="true"></i>';
...
$string['completion-shorthand-alt-manual-y-override'] = 'Completed <i class="fa fa-triangle-exclamation text-white" aria-hidden="true"></i>';
$string['completion-shorthand-fail'] = 'Completed <i class="fa fa-triangle-exclamation text-white" aria-hidden="true"></i>';
$string['completion-shorthand-n'] = 'Not completed';
$string['completion-shorthand-n-override'] = 'Not completed <i class="fa fa-triangle-exclamation text-white" aria-hidden="true"></i>';
$string['completion-shorthand-pass'] = 'Completed (achieved pass grade)';
$string['completion-shorthand-y'] = 'Completed';
$string['completion-shorthand-y-override'] = 'Completed <i class="fa fa-triangle-exclamation text-white" aria-hidden="true"></i>';
