...
run_iomad public/local/institutionpack/cli/seed_demo_features.php \
    --company=GV_SCHOOL \
    --course=GV-ORIENTATION-2026 \
    --learner-prefix=SCH_STUDENT_ \
    --label="Demo School" \
    --limit=100

run_iomad public/local/institutionpack/cli/seed_demo_features.php \
    --company=NBU_ENGINEERING \
    --course=NBU-ORIENTATION-2026 \
    --learner-prefix=UNI_STU_ \
